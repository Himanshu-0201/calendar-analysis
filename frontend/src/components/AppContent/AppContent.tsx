...
import { modifyEventsForPieChart, modifyEventsForMatrixChart, modifyEventsForTable, normalizedTitleFunction, modifyEventsForOverlayTable } from "../../utils/mathUtils.ts";
...
import EventsOverlay from "../../Ui/EventsOverlay/EventsOverlay.tsx";
import EventsOverlayTable from "../Tables/EventsOverlayTable/EventsOverlayTable.tsx";
import { OverlayTableElement } from "../../models/TablesModels.ts";
...
const AppContent = ({ startTime, endTime, currDateStr, eventsList, eventsShowTillCurrentTime, updateEvents, loaderClose }) => {
    ...
    const [overlayTableContent, setOverlayTableContent] = useState<OverlayTableElement []>([]);
    ...
    const showEventDetails = (title: string) => {

        const filteredEvents = modifyEventsForOverlayTable(eventsList, title);
        setShowOverlay(true);
        setOverlayTableContent(filteredEvents);
    }
        ...
        <>
            {
                loading ?
                    ...
                    <>
                        ...
                        {
                            showOverlay &&
                            <EventsOverlay onCloseOverlay={() => setShowOverlay(false)}>
                                <EventsOverlayTable tableEvents = {overlayTableContent} />
                            </EventsOverlay>}
                        ...
                        <div className="grid grid-cols-1 gap-4  py-6 bg-gray-50 pt-[5px] md:grid-cols-10">
                            ...
                            <div className="col-span-1 md:col-span-6 xl:col-span-4  p-4 bg-white rounded-lg shadow-md border">
                                ...
                                <Table
                                    ...
                                    rowClickHandler={showEventDetails}
                                />
                            </div>
